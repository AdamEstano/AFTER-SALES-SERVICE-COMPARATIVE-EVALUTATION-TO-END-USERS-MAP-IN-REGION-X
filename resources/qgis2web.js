...
map.getView().fit([13735629.196186, 838096.421737, 13996115.715125, 978260.966774], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">AFTER-SALES SERVICE COMPARATIVE EVALUATION TO END-USERS MAP IN REGION X</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_ENDUSERSBENEFICIARIES_2,
    colName: 'NAME OF BENEFICIARIES',
    zoom: 10,
    collapsed: true,
    map: map,
    maxResults: 10,
